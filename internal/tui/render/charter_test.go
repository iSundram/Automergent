...
var pendingSweep = []string{
	...
	"tui/commands/cmd_export.go",
	"tui/commands/cmd_feedback.go",
	"tui/commands/cmd_files.go",
	"tui/commands/cmd_github.go",
	"tui/commands/cmd_goal.go",
	"tui/commands/cmd_init.go",
	"tui/commands/cmd_knowledge.go",
	"tui/commands/cmd_lsp.go",
	"tui/commands/cmd_mcp.go",
	"tui/commands/cmd_memory.go",
	"tui/commands/cmd_mode.go",
	"tui/commands/cmd_model.go",
	"tui/commands/cmd_new.go",
	"tui/commands/cmd_permissions.go",
	"tui/commands/cmd_plan.go",
	"tui/commands/cmd_provider.go",
	"tui/commands/cmd_provider_config.go",
	"tui/commands/cmd_recap.go",
	"tui/commands/cmd_rename.go",
	"tui/commands/cmd_review.go",
	"tui/commands/cmd_rewind.go",
	"tui/commands/cmd_run.go",
	"tui/commands/cmd_search.go",
	"tui/commands/cmd_security_review.go",
	"tui/commands/cmd_sessions.go",
	"tui/commands/cmd_stats.go",
	"tui/commands/cmd_summary.go",
	"tui/commands/cmd_test_cmd.go",
	"tui/commands/cmd_theme.go",
	"tui/commands/cmd_tldr.go",
	"tui/commands/cmd_tree.go",
	"tui/commands/cmd_version.go",
	"tui/commands/cmd_workflow.go",
	"tui/commands/command.go",
	"tui/commands/help.go",
	"tui/commands/cmd_doctor.go",
	"tui/commands/cmd_dream.go",
	"tui/commands/cmd_effort.go",
	"tui/commands/cmd_env.go",
	"tui/commands/cmd_error.go",
	"tui/commands/cmd_add_dir.go",
	"tui/commands/cmd_api_key.go",
	"tui/commands/cmd_artifact.go",
	"tui/commands/cmd_branch.go",
	"tui/commands/cmd_cancel.go",
	"tui/commands/cmd_commands.go",
	"tui/commands/cmd_commit.go",
	"tui/commands/cmd_compact.go",
	"tui/commands/cmd_config.go",
	"tui/commands/cmd_context.go",
	"tui/commands/cmd_directory.go",
	"tui/app/command_glue.go",
	"tui/app/host.go",
	"tui/app/hud.go",
	"tui/app/workflow.go",
	"tui/components/artifact_browser.go",
	"tui/components/conversation_render.go",
